...
ERROR_CODE_DEFINITION(26, pdf_sampling_error, "Error while sampling from PDF: ")
...
ERROR_CODE_DEFINITION(38, bad_context_size, "Input context is not the right size. ")
ERROR_CODE_DEFINITION(39, inference_configuration_error, "Unable to configure model inference: ")
ERROR_CODE_DEFINITION(40, serialize_error, "Unknown error while serializing.")
ERROR_CODE_DEFINITION(41, extension_error, "Error from extension: ")
//! [Error Definitions]
